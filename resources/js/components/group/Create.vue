                                                ...
                                                <v-layout row wrap>
                                                    <v-flex sm4>
                                                        ...
                                                        <el-select v-model="attr.attribute" clearable placeholder="Attribute">
                                                            <el-option v-for="item in attributes" :key="item.id" :label="item.name" :value="item.id">
                                                            </el-option>
                                                        </el-select>
                                                    </v-flex>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            this.form.attribute_arr = this.attribute_arr
            this.errors = {}
            this.loading = true
                            ...
                            for (let key_1 = 0; key_1 < element_1.tags.length; key_1++) {
                                ...
                                if (element_a.text != element_b.text && element_a.text != '' && element_b.text != '' && element != element_1) {
                                    ...
                                    this.itemAttribute_arr.push({
                                        ...
                                        attribute_2: element_1.attribute,
                                        attribute_value_1: element_a.text,
                                        attribute_value_2: element_b.text,
                                        sku_no: this.form.prefix + ("00000000" + (parseInt(this.unique_sku) + i)).slice(-8),
                                        price: 0,
                                        reorder_point: 0,
                                        attribute_id: element.attribute,
