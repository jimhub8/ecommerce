                    ...
                    <v-flex sm12 md12>
                        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#carouselExampleIndicators" v-for="(item, index) in slider" :key="index" :data-slide-to="parseInt(index)+parseInt(1)"></li>
                            </ol>
                            <div class="carousel-inner" id="container">
                                <div class="carousel-item active">
                                    <div class="image-container">
                                        <img class="d-block w-100" :src="sliderS.image" alt="First slide" style="height: 60vh;">
                                        ...
                                        <div class="carousel-caption d-none d-md-block">
                                            <h1 class="wow fadeInUp" data-wow-delay="0.8s">
                                                <!-- <strong>{{ sliderS.name }}</strong> -->
                                            </h1>
                                            <v-divider></v-divider>
                                            <p class="wow fadeInUp" data-wow-delay="1.2s" style="color: rgba(240, 240, 240, 0.77);">
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi fugit sed ex quam dolorum pariatur molestiae sequi vero, sapiente necessitatibus libero nulla error at veniam quis in ut? Expedita, itaque.
                                                <!-- <b>{{ sliderS.description }}</b> -->
                                            </p>
                                            <!-- <p class="wow fadeInUp" data-wow-delay="1.6s">For only {{ sliderS.price }}</p>
                                            <v-btn @click="view(singleP)" raised color="primary" data-wow-delay="2.0s">See Item</v-btn> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item" v-for="product in slider" :key="product.id">
                                    <div class="image-container">
